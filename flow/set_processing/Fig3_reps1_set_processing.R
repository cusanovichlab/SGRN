...
cells_coords = matrix(c(25000,15000,45000,159000,221000,197000,182000,50000,10000,16000,85000,212000),nrow=6,ncol=2)
...
singlets_coords = matrix(c(35000,90000,210000,240000,215000,25000,20000,0,40000,150000,200000,205000,35000,15000),nrow=7,ncol=2)
