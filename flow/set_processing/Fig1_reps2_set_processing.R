...
singlets_coords = matrix(c(45000,100000,220000,255000,250000,35000,30000,10000,50000,160000,225000,242000,45000,25000),nrow=7,ncol=2)
...
write.gatingML(flowEnv,paste0("./gating_files/",figure,"_gates_",replicate,".gating-ml2.xml"))
