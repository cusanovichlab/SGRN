...
all = rbind(rep1,rep2)
all = rbind(all,rep3)
all = separate(all,exp_name,into=c("Enzyme","Target","Amount"),remove=F)
...
all[is.na(all$Amount),]$Amount = "0ng"
...
all_onechannel = select(all,exp_name:Amount,Replicate,Channel,PercPos:MFI)
